...
public class SQLConstants {
    ...
    public static final String CREATE_CONFIG = "INSERT IDN_REMOTE_FETCH_CONFIG (TENANT_ID, IS_ENABLED, USER_NAME, " +
    ...
    public static final String LIST_ENABLED_CONFIGS = "SELECT * FROM `IDN_REMOTE_FETCH_CONFIG` WHERE IS_ENABLED = 1";
    ...
    public static final String LIST_BASIC_CONFIGS_BY_TENANT = String.format("SELECT CONFIG.ID, CONFIG.IS_ENABLED," +
                    " CONFIG.REPO_MANAGER_TYPE, CONFIG.ACTION_LISTENER_TYPE, CONFIG.CONFIG_DEPLOYER_TYPE ,CONFIG" + ".REMOTE_FETCH_NAME," +
    ...
    public static final String GET_CONFIG = "SELECT * FROM `IDN_REMOTE_FETCH_CONFIG` WHERE ID = ?";
